            ...
            {progress ? (
              ...
              <>
                <p className={styles.infoText}>
                  Все данные (цели, фото, план, дневник, вишлист, карта желаний) хранятся локально на этом
                  устройстве и не синхронизируются автоматически. Экспорт сохраняет всё в один файл —
                  используй его как резервную копию и для переноса на другое устройство: там открой это же
                  меню и нажми «Импорт».
                </p>
